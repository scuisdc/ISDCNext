...
$db = new mysqli(ISDCOJ_MYSQL_HOST, ISDCOJ_MYSQL_USER, ISDCOJ_MYSQL_PWD, "wordpress");
...
$query = 'select * from ' . ISDCOJ_MYSQL_TBWPLOGIN . " where user_login = '".$userid."'";
